        ...
        <section className="relative flex h-screen min-h-fit w-full items-center bg-[var(--primary)] pt-[72px]">
            <div className="grid-sqs w-full [--grid-cols:8] [--grid-rows:20] md:[--grid-cols:24] md:[--grid-rows:22]">
                <div
                    ...
                    className="relative col-start-2 col-end-10 row-start-2 row-end-10 md:col-start-2 md:col-end-12 md:row-start-2 md:row-end-23"
                >
                ...
                <div className="col-start-2 col-end-10 row-start-10 row-end-15 flex flex-col items-center justify-center text-center leading-relaxed md:col-start-13 md:col-end-25 md:row-start-7 md:row-end-13">
                    <h1
                        data-animate="fade-up"
                        className="mb-8 max-w-full leading-[calc(1.2em*(1+(1-4.5)/25))] sm:max-w-[70%] md:max-w-full"
                    >
                        Find your internal ease.
                    </h1>
                    <p
                        data-animate="fade"
                        className="max-w-full text-lg sm:max-w-[70%] md:max-w-full"
                    >
                ...
                <div
                    data-animate="fade-up"
                    className="md col-start-2 col-end-10 row-start-15 row-end-18 flex flex-col justify-center text-center md:col-start-13 md:col-end-25 md:row-start-13 md:row-end-15"
                >
