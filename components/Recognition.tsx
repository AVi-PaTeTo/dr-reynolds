    ...
    return (
        <section className="h-full">
            <div className="grid-sqs grid-flush relative h-full bg-[#cfd8dc] text-[var(--accent)] [--grid-cols:8] [--grid-rows:24] md:[--grid-cols:24] md:[--grid-rows:21]">
                <div className="fade-up col-start-1 col-end-11 row-start-1 row-end-9 md:col-start-1 md:col-end-13 md:row-start-1 md:row-end-22">
                ...
                <div className="fade-up col-start-1 col-end-11 row-start-23 row-end-25 md:col-start-13 md:col-end-27 md:row-start-20 md:row-end-22">
