...
export default function Speciality() {
    return (
        <section className="bg-[var(--primary)] py-[6.6vmax]">
            <div className="w-full px-[3.75vw] pb-[50px]">
                <h3
                    data-animate="fade-up"
                    className="text-center text-[calc((3-1)*(0.012*min(100vh,900px))+1rem)] font-[500] md:text-[calc((3-1)*1.2vw+1rem)]"
                >
                    My Specialties
                </h3>
            </div>
            <ul className="tablet:grid-cols-2 tablet:grid-rows-2 grid gap-5 px-[3.75vw] wrap-break-word md:grid-cols-3 md:grid-rows-none">
                <li className="flex flex-col justify-between bg-[var(--secondary)] p-5 outline-1 outline-[var(--accent)]">
                    <div>
                        <h2 data-animate="fade-up" className="leading-tight">
                            Anxiety & Panic
                        </h2>
                        <div className="mt-[10%] text-[calc((0.9-1)*1.2vw+1rem)] tracking-wider">
                            <p data-animate="fade" className="mb-2">
                    ...
                    <div
                        data-animate="fade-up"
                        className="mx-auto mt-[10%] w-[75%] overflow-hidden rounded-full"
                    >
                        <Image
                            src={card1}
                            alt=""
